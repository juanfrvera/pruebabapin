...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <table width="100%"  >
        ...
        <tr>
            <td>
                <asp:ValidationSummary ID="vsFilterModalidadContratacion" runat="server" DisplayMode="BulletList"
                    ValidationGroup="FilterModalidadContratacion" ShowSummary="false"
