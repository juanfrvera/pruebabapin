...
<asp:BoundField DataField="PlanTipo_Nombre" HeaderText="Tipo de Plan" SortExpression="PlanTipo_Nombre" HeaderStyle-Width="20%"/>
	...
	<asp:BoundField DataField="AnioInicial" HeaderText="Año Inicial" SortExpression="AnioInicial" HeaderStyle-Width="10%"/>
	<asp:BoundField DataField="AnioFinal" HeaderText="Año Final" SortExpression="AnioFinal" HeaderStyle-Width="10%"/>
