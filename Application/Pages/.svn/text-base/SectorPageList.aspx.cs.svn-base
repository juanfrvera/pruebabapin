...
namespace UI.Web
{    
	public partial class SectorPageList : PageList<nc.Sector ,nc.SectorFilter, nc.SectorResult, int>
    {
		...
		protected override IViewService<nc.Sector ,nc.SectorFilter,SectorResult, int> ViewService
        {
            get { return Service; }
        }
