...
{
    public abstract class _ProyectoProductoData : EntityData<ProyectoProducto,ProyectoProductoFilter,ProyectoProductoResult,int>
    { 		
		#region Context        
        ...
        #endregion		
		#region Get
		public override int GetId(nc.ProyectoProducto entity)
		{			
			return entity.IdProyectoProducto;
		}		
		public override ProyectoProducto GetByEntity(ProyectoProducto entity)
        {
            return this.GetById(entity.IdProyectoProducto);
        }
        public override ProyectoProducto GetById(int id)
        {
            return (from o in this.Table where o.IdProyectoProducto == id select o).FirstOrDefault();
        }
		#endregion
		#region Query
		protected override IQueryable<ProyectoProducto> Query(ProyectoProductoFilter filter)
        {
			return (from o in this.Table
                      where (filter.IdProyectoProducto == null || filter.IdProyectoProducto == 0 || o.IdProyectoProducto==filter.IdProyectoProducto)
        ...
        protected override IQueryable<ProyectoProductoResult> QueryResult(ProyectoProductoFilter filter)
        {
		  return (from o in Query(filter)					
				   ...
				   select new ProyectoProductoResult(){
		...
		#endregion
		#region Copy
		public override nc.ProyectoProducto Copy(nc.ProyectoProducto entity)
        {           
            nc.ProyectoProducto _new = new nc.ProyectoProducto();
		 _new.IdProyecto= entity.IdProyecto;
		 _new.IdObjetivo= entity.IdObjetivo;
		return _new;			
        }
		public override int CopyAndSave(ProyectoProducto entity,string renameFormat)
        {
            ProyectoProducto  newEntity = Copy(entity);
            Add(newEntity);
			return GetId(newEntity);
        }
		#endregion
		#region Set
		public override void SetId(ProyectoProducto entity, int id)
        {            
            entity.IdProyectoProducto = id;            
        }
		public override void Set(ProyectoProducto source,ProyectoProducto target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoProducto= source.IdProyectoProducto ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdObjetivo= source.IdObjetivo ;
		 		  
		}
		public override void Set(ProyectoProductoResult source,ProyectoProducto target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoProducto= source.IdProyectoProducto ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdObjetivo= source.IdObjetivo ;
		...
		public override void Set(ProyectoProducto source,ProyectoProductoResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoProducto= source.IdProyectoProducto ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdObjetivo= source.IdObjetivo ;
		...
		public override void Set(ProyectoProductoResult source,ProyectoProductoResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoProducto= source.IdProyectoProducto ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdObjetivo= source.IdObjetivo ;
		...
		#endregion			
		#region Equals
		public override bool Equals(ProyectoProducto source,ProyectoProducto target)
        {
		...
		public override bool Equals(ProyectoProductoResult source,ProyectoProductoResult target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
