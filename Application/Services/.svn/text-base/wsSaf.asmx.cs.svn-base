...
namespace Application.Services
{
    ...
    public class wsSaf : System.Web.Services.WebService
    {
        [WebMethod]
        public string[] GetSimpleList(string prefixText, int count)
        {
            List<nc.SimpleResult<int>> result = SafService.Current.GetSimpleList(new nc.SafFilter() { Denominacion  = prefixText + "%", PageSize = count, OrderByProperty = "Codigo", Activo = true });
