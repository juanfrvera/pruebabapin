<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProyectoRelacionTipoFilter.ascx.cs" Inherits="UI.Web.ProyectoRelacionTipoFilter" %>
...
<tr>
		...
		<td align="right" valign="bottom" >
		    ...
		    &nbsp;<asp:Button  ID ="btSearch"  runat = "server" Text="Buscar" OnClick ="btSearch_Click"  Visible="true" ValidationGroup="FilterProyectoRelacionTipo" />
		</td>
	</tr>
</table>
