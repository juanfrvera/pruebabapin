...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <table width="100%"  >
		...
		<tr>
		    <td>
		        <asp:ValidationSummary id="vsFilterGeoreferenciacionPunto" runat="server" DisplayMode="BulletList" ValidationGroup="FilterGeoreferenciacionPunto" ShowSummary="false" ShowMessageBox="True"></asp:ValidationSummary>
		    </td>
		</tr>
		<tr>
            <td>
