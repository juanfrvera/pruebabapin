...
<%@ Register Tagprefix="uc"  TagName="FilterFilterProyectoComentarioTecnico" Src="ProyectoComentarioTecnicoFilter.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <table width="100%"  >
                ...
                <asp:UpdatePanel ID="upSearch" runat="server">
                    <ContentTemplate>
					    <asp:Panel runat="server" GroupingText="Filtro de Búsqueda"  ID="pnlFilter" >
                            <div  >
                               <uc:FilterFilterProyectoComentarioTecnico runat="server" ID="ftProyectoComentarioTecnico" ></uc:FilterFilterProyectoComentarioTecnico>
						    </div>
                        </asp:Panel>
                    </ContentTemplate>
                </asp:UpdatePanel>
        ...
        <tr>
            <td>
                <asp:ValidationSummary ID="vsFilterProyectoComentarioTecnico" runat="server" DisplayMode="BulletList"
                    ValidationGroup="FilterProyectoComentarioTecnico" ShowSummary="false"
