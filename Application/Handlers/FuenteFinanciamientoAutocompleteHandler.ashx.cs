...
namespace UI.Web
{
    ...
    public class FuenteFinanciamientoAutocompleteHandler : IHttpHandler
    {

        public void ProcessRequest(HttpContext context)
        {
            nc.FuenteFinanciamientoFilter filter = null;
            string query = "";
            int aux;
            ...
            try
            {
                ...
                filter = JsonConvert.DeserializeObject<nc.FuenteFinanciamientoFilter>(jsonFilter);
            ...
            if (filter == null) filter = new nc.FuenteFinanciamientoFilter();
            ...
            nodes.Nodes = FuenteFinanciamientoService.Current.GetNodesResult(filter);
