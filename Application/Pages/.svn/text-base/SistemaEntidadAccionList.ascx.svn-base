<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SistemaEntidadAccionList.ascx.cs" Inherits=" UI.Web.SistemaEntidadAccionList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="SistemaEntidad_Nombre" HeaderText="Sistema Entidad" SortExpression="SistemaEntidad_Nombre" HeaderStyle-Width="20%" />
	<asp:BoundField DataField="SistemaAccion_Nombre" HeaderText="Sistema Acción" SortExpression="SistemaAccion_Nombre" HeaderStyle-Width="20%"/>
	<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre" HeaderStyle-Width="51%" >            
            <ItemTemplate>
                <asp:Label ID="lblNombre" runat="server" Text='<%# Contract.DataHelper.CutString((string)Eval("Nombre"),80) %>' ToolTip='<%# Eval("Nombre") %>'  ></asp:Label>
            </ItemTemplate>
    </asp:TemplateField>
