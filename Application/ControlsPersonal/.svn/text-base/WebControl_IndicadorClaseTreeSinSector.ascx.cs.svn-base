...
{
    public partial class WebControl_IndicadorClaseTreeSinSector : WebControlTreeSelect<nc.IndicadorClaseFilter>
    {
        #region Properties
        ...
        protected override void _SetControls()
        {
            ...
            RootText = "Root";
            TreeTitle = "Indicador";
            TreeHandler = "../Handlers/IndicadorClaseSinSectorHandler.ashx";
