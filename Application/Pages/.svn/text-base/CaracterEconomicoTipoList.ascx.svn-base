<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CaracterEconomicoTipoList.ascx.cs" Inherits=" UI.Web.CaracterEconomicoTipoList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
    <asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre"  HeaderStyle-Width="83%">            
            <ItemTemplate>
	...
	<asp:BoundField DataField="Nivel" HeaderText="Nivel" SortExpression="Nivel" HeaderStyle-Width="8%"/>
