...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
   <asp:TemplateField   HeaderText="Padre"  SortExpression="CaracterEconomicoPadre_BreadcrumbCodeOrden" HeaderStyle-Width="25%" >            
            <ItemTemplate>
	...
	<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre"  HeaderStyle-Width="40%">            
            <ItemTemplate>
	...
	<asp:BoundField DataField="CaracterEconomicoTipo_Nombre" HeaderText="Nivel/Tipo" SortExpression="CaracterEconomicoTipo_Nombre" HeaderStyle-Width="10%"/>
