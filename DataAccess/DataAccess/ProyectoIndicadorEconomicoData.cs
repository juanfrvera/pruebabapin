...
{
    public class ProyectoIndicadorEconomicoData : _ProyectoIndicadorEconomicoData 
    { 
	   #region Singleton
	   private static volatile ProyectoIndicadorEconomicoData current;
	   private static object syncRoot = new Object();

	   //private ProyectoIndicadorEconomicoData() {}
	   public static ProyectoIndicadorEconomicoData Current
	   {
		  get 
		  {
			 if (current == null) 
			 {
				...
				{
				   if (current == null) 
					   current = new ProyectoIndicadorEconomicoData();
				}
			 }
			 return current;
		  }
       ...
       #endregion
       public override string IdFieldName { get { return "IdProyectoIndicadorEconomico"; } }
