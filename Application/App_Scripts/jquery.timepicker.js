    ...
    jQuery.fn.timepicker = function() {
        this.each(function() {
            ...
            for (hr in hrs) {
                ...
                if (parseInt(hrs[hr]) == h) { output += ' selected'; hVal = h; }
            ...
            for (mn in mins) {
                ...
                if (parseInt(mins[mn]) == m) { output += ' selected'; mVal = m; }
            ...
            //line above is throwing an exception - CM/Jason.Harris
            $(this).css('display', 'none').after(output);

            //set an initial value for the hidden input - CM/Jason.Harris           
            var initValue = hVal + ':' + mVal + pVal;
            $(this).val(initValue);
        });
