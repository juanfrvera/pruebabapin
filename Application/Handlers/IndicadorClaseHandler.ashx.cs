...
namespace UI.Web
{
    ...
    public class IndicadorClaseHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            idIndicadorRubro = filter.IdIndicadorRubro;
            if (idIndicadorRubro != null && idIndicadorRubro == -1)
                idIndicadorRubro = null;
            ...
            if(id == null)
                result = IndicadorClaseService.Current.GetNodesResult(new nc.IndicadorClaseFilter() { Activo = filter.Activo, IdIndicadorClase = id, IdIndicadorRubro = idIndicadorRubro, IdIndicadorTipo = filter.IdIndicadorTipo, OrderByProperty = "Id" });
