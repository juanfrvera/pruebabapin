...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <table width="100%"  >
                ...
                <asp:UpdatePanel ID="upListButtons" runat="server">
                    <ContentTemplate>
                      <table width="100%">
                        <tr>
                            <td align="left">
								&nbsp;<asp:Button  ID ="btTransferencia"  Enabled="false" runat = "server" Text="Agregar OficinaSaf" OnClick ="btNew_Click"  /> 
		...
		<tr>
		 ...
		 <tr>
           <td>
           <!-- BEGIN EDIT OficinaSaf-->
            <asp:Panel ID="pnPopUpEditOficinaSaf" runat="server" Width="800px" Style="background-color: #ffffff; border: solid 2px #ffffff; border-color: Gray;">
            <asp:Panel ID="pnPopUpEditOficinaSafDragHandle" runat="server" Style="cursor: move;">
            <table width="100%" cellpadding="0" cellspacing="5">
                <tr class="menutop" >
                    <th align="center" height="10">Edici&oacute;n OficinaSaf</th>                    
                </tr>
            </table>
            </asp:Panel>
            <asp:Panel ID="pnEditOficinaSaf" runat="server">             
                <asp:UpdatePanel ID="upEditOficinaSaf" runat="server" UpdateMode="Conditional" >
                <ContentTemplate>
                <table >	             
                <tr>
                    <td>                      
                        <uc:EditOficinaSafrunat="server" ID="editOficinaSaf" ></uc:EditOficinaSaf>                           
                    </td>
                </tr>               
            ...
            <asp:Button ID="btPnOficinaSaf" runat="server" Text="Button" Style="display: none" />
            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtenderEditOficinaSaf" runat="server" CancelControlID="btPnOficinaSaf" 
					PopupDragHandleControlID="pnPopUpEditOficinaSafDragHandle" PopupControlID="pnPopUpEditOficinaSaf"
					OkControlID="Button2" TargetControlID="btPnOficinaSaf" BackgroundCssClass="modalBackground" />
            </asp:Panel>
            <!--END EDIT OficinaSaf -->            
           </td>
        </tr>
