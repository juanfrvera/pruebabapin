...
namespace Contract.Base
{
    ...
    public abstract class _FinalidadFuncionTipoFilter : Filter
    {   
		#region Private
		...
		#endregion
		#region Properties
		[DataMember(Name = "IdFinalidadFuncionTipo", IsRequired = false)]public int? IdFinalidadFuncionTipo{get;set;}		
