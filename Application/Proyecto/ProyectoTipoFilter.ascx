...
<tr>
	    <td class="tdFilter" ><div ><asp:Literal ID="liSigla" Text="Sigla" runat="server" ></asp:Literal>&nbsp;<asp:RegularExpressionValidator ID="revSigla" runat="server"  ControlToValidate="txtSigla" ValidationGroup="FilterProyectoTipo" Text="*" Width="1px" Height="1px"  ErrorMessage="La Sigla no es válida"></asp:RegularExpressionValidator></div>
		<div><asp:TextBox ID="txtSigla" runat="server" CssClass="field_input" MaxLength="3"  ></asp:TextBox></div>
        </td><td class="tdFilter" ><div ><asp:Literal ID="liNombre" Text="Nombre" runat="server" ></asp:Literal>&nbsp;<asp:RegularExpressionValidator ID="revNombre" runat="server"  ControlToValidate="txtNombre" ValidationGroup="FilterProyectoTipo" Text="*" Width="1px" Height="1px"  ErrorMessage="El Nombre no es válido"></asp:RegularExpressionValidator></div>
