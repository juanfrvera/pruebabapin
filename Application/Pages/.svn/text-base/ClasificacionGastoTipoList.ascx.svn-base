<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ClasificacionGastoTipoList.ascx.cs" Inherits=" UI.Web.ClasificacionGastoTipoList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre"  HeaderStyle-Width="81%">            
            <ItemTemplate>
	...
	<asp:BoundField DataField="Nivel" HeaderText="Nivel" SortExpression="Nivel" HeaderStyle-Width="10%"/>
