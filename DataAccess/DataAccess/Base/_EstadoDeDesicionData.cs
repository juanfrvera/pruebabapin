...
{
    public abstract class _EstadoDeDesicionData : EntityData<EstadoDeDesicion,EstadoDeDesicionFilter,EstadoDeDesicionResult,int>
    { 		
		#region Context        
        ...
        #endregion		
		#region Get
		public override int GetId(nc.EstadoDeDesicion entity)
		{			
			return entity.IdEstadoDeDesicion;
		}		
		public override EstadoDeDesicion GetByEntity(EstadoDeDesicion entity)
        {
            return this.GetById(entity.IdEstadoDeDesicion);
        }
        public override EstadoDeDesicion GetById(int id)
        {
            return (from o in this.Table where o.IdEstadoDeDesicion == id select o).FirstOrDefault();
        }
		#endregion
		#region Query
		protected override IQueryable<EstadoDeDesicion> Query(EstadoDeDesicionFilter filter)
        {
			return (from o in this.Table
                      where (filter.IdEstadoDeDesicion == null || filter.IdEstadoDeDesicion == 0 || o.IdEstadoDeDesicion==filter.IdEstadoDeDesicion)
        ...
        protected override IQueryable<EstadoDeDesicionResult> QueryResult(EstadoDeDesicionFilter filter)
        {
		  return (from o in Query(filter)					
					select new EstadoDeDesicionResult(){
		...
		#endregion
		#region Copy
		public override nc.EstadoDeDesicion Copy(nc.EstadoDeDesicion entity)
        {           
            nc.EstadoDeDesicion _new = new nc.EstadoDeDesicion();
		...
		public override int CopyAndSave(EstadoDeDesicion entity,string renameFormat)
        {
            EstadoDeDesicion  newEntity = Copy(entity);
		...
		#endregion
		#region Set
		public override void SetId(EstadoDeDesicion entity, int id)
        {            
            entity.IdEstadoDeDesicion = id;            
        }
		public override void Set(EstadoDeDesicion source,EstadoDeDesicion target,bool hadSetId)
		{		   
		if(hadSetId)target.IdEstadoDeDesicion= source.IdEstadoDeDesicion ;
		...
		public override void Set(EstadoDeDesicionResult source,EstadoDeDesicion target,bool hadSetId)
		{		   
		if(hadSetId)target.IdEstadoDeDesicion= source.IdEstadoDeDesicion ;
		 target.Nombre= source.Nombre ;
		 target.Codigo= source.Codigo ;
		...
		public override void Set(EstadoDeDesicion source,EstadoDeDesicionResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdEstadoDeDesicion= source.IdEstadoDeDesicion ;
		 target.Nombre= source.Nombre ;
		 target.Codigo= source.Codigo ;
		...
		public override void Set(EstadoDeDesicionResult source,EstadoDeDesicionResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdEstadoDeDesicion= source.IdEstadoDeDesicion ;
		 target.Nombre= source.Nombre ;
		 target.Codigo= source.Codigo ;
		...
		#endregion			
		#region Equals
		public override bool Equals(EstadoDeDesicion source,EstadoDeDesicion target)
        {
		...
		public override bool Equals(EstadoDeDesicionResult source,EstadoDeDesicionResult target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
