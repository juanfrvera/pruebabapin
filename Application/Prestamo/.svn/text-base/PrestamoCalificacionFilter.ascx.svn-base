<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrestamoCalificacionFilter.ascx.cs" Inherits="UI.Web.PrestamoCalificacionFilter" %>
...
<tr>
		...
		<td align="right" valign="bottom" >
		    <asp:Button  ID ="btClear"  runat = "server" Text="Limpiar" OnClick ="btClear_Click"  Visible="true" ValidationGroup="FilterPrestamoCalificacion" />
