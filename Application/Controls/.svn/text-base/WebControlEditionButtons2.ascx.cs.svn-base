...
namespace UI.Web
{
    public partial class WebControlEditionButtons2 : WebControlBase, IEditionButtons
    {
        ...
        public void SetApplyButtonAsDefault()
        {
            Page.Form.DefaultButton = btSave.UniqueID;
        }
    }
}