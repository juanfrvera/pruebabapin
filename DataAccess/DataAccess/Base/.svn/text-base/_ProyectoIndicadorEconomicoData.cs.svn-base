...
{
    public abstract class _ProyectoIndicadorEconomicoData : EntityData<ProyectoIndicadorEconomico,ProyectoIndicadorEconomicoFilter,ProyectoIndicadorEconomicoResult,int>
    { 		
		#region Context        
        ...
        #endregion		
		#region Get
		public override int GetId(nc.ProyectoIndicadorEconomico entity)
		{			
			return entity.IdProyectoIndicadorEconomico;
		}		
		public override ProyectoIndicadorEconomico GetByEntity(ProyectoIndicadorEconomico entity)
        {
            return this.GetById(entity.IdProyectoIndicadorEconomico);
        }
        public override ProyectoIndicadorEconomico GetById(int id)
        {
            return (from o in this.Table where o.IdProyectoIndicadorEconomico == id select o).FirstOrDefault();
        }
		#endregion
		#region Query
		protected override IQueryable<ProyectoIndicadorEconomico> Query(ProyectoIndicadorEconomicoFilter filter)
        {
			return (from o in this.Table
                      where (filter.IdProyectoIndicadorEconomico == null || o.IdProyectoIndicadorEconomico >=  filter.IdProyectoIndicadorEconomico) && (filter.IdProyectoIndicadorEconomico_To == null || o.IdProyectoIndicadorEconomico <= filter.IdProyectoIndicadorEconomico_To)
        ...
        protected override IQueryable<ProyectoIndicadorEconomicoResult> QueryResult(ProyectoIndicadorEconomicoFilter filter)
        {
		  return (from o in Query(filter)					
				   ...
				   select new ProyectoIndicadorEconomicoResult(){
					 IdProyectoIndicadorEconomico=o.IdProyectoIndicadorEconomico
		...
		#endregion
		#region Copy
		public override nc.ProyectoIndicadorEconomico Copy(nc.ProyectoIndicadorEconomico entity)
        {           
            nc.ProyectoIndicadorEconomico _new = new nc.ProyectoIndicadorEconomico();
		...
		public override int CopyAndSave(ProyectoIndicadorEconomico entity,string renameFormat)
        {
            ProyectoIndicadorEconomico  newEntity = Copy(entity);
		...
		#endregion
		#region Set
		public override void SetId(ProyectoIndicadorEconomico entity, int id)
        {            
            entity.IdProyectoIndicadorEconomico = id;            
        }
		public override void Set(ProyectoIndicadorEconomico source,ProyectoIndicadorEconomico target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoIndicadorEconomico= source.IdProyectoIndicadorEconomico ;
		...
		public override void Set(ProyectoIndicadorEconomicoResult source,ProyectoIndicadorEconomico target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoIndicadorEconomico= source.IdProyectoIndicadorEconomico ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdIndicadorClase= source.IdIndicadorClase ;
		...
		public override void Set(ProyectoIndicadorEconomico source,ProyectoIndicadorEconomicoResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoIndicadorEconomico= source.IdProyectoIndicadorEconomico ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdIndicadorClase= source.IdIndicadorClase ;
		...
		public override void Set(ProyectoIndicadorEconomicoResult source,ProyectoIndicadorEconomicoResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoIndicadorEconomico= source.IdProyectoIndicadorEconomico ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdIndicadorClase= source.IdIndicadorClase ;
		...
		#endregion			
		#region Equals
		public override bool Equals(ProyectoIndicadorEconomico source,ProyectoIndicadorEconomico target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
         if(!source.IdProyectoIndicadorEconomico.Equals(target.IdProyectoIndicadorEconomico))return false;
		...
		public override bool Equals(ProyectoIndicadorEconomicoResult source,ProyectoIndicadorEconomicoResult target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
