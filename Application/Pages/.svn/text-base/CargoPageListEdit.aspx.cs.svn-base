...
namespace UI.Web
{    
	public partial class CargoPageListEdit : PageListEdit<nc.Cargo ,nc.CargoFilter, nc.CargoResult, int>
    {
		#region Override
		protected override void _Initialize()
        {
			base._Initialize();
            pnPopUpEditCargo.Attributes.CssStyle.Add("display", "none");
        }	
        ...
        {            
            ...
            IsActivePopup = true;
            upEditCargo.Update();
            ModalPopupExtenderEditCargo.Show();            
        }
        ...
        protected override void HideEdit()
        {
            ...
            IsActivePopup = false;
            ActivePopupName = "";
            ModalPopupExtenderEditCargo.Hide();
        }
        #endregion
		#region Events
