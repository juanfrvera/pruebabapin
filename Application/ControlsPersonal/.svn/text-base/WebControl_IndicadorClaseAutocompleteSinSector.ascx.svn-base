<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebControl_IndicadorClaseAutocompleteSinSector.ascx.cs" Inherits="UI.Web.WebControl_IndicadorClaseAutocompleteSinSector" %>
