...
namespace UI.Web
{    
	public partial class IndicadorClasePageListEdit : PageListEdit<nc.IndicadorClaseCompose ,nc.IndicadorClaseFilter, nc.IndicadorClaseResult, int>
    {
		#region Override
		protected override void _Initialize()
        {
			base._Initialize();
            pnPopUpEditIndicadorClase.Attributes.CssStyle.Add("display", "none");
        }	
        ...
        {            
            base.ShowEdit();
            IsActivePopup = true;
            upEditIndicadorClase.Update();
            ModalPopupExtenderEditIndicadorClase.Show();            
        }
        ...
        protected override void HideEdit()
        {
            ...
            IsActivePopup = false;
            ActivePopupName = "";
            ModalPopupExtenderEditIndicadorClase.Hide();
        }
        #endregion
		#region Events
