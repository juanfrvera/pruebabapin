...
<asp:GridView ID="Grid" runat="server" Width="100%"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Denominación" SortExpression="ProyectoDenominacion" HeaderStyle-Width="30%">
            <ItemTemplate>
        ...
        <asp:BoundField DataField="Estado_Nombre" HeaderText="Estado" SortExpression="Estado_Nombre" HeaderStyle-Width="10%" />
