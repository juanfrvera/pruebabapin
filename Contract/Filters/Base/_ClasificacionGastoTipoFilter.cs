...
namespace Contract.Base
{
    ...
    public abstract class _ClasificacionGastoTipoFilter : Filter
    {   
		#region Private
		...
		#endregion
		#region Properties
		[DataMember(Name = "IdClasificacionGastoTipo", IsRequired = false)]public int? IdClasificacionGastoTipo{get;set;}		
