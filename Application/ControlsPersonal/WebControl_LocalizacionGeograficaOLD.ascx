<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebControl_LocalizacionGeograficaOLD.ascx.cs" Inherits="UI.Web.WebControl_LocalizacionGeograficaOLD" %>
...
<asp:Panel ID="pnControl" runat="server" >
    ...
    <div id="<%=ClientID%>_panel"  style="visibility:hidden;  height:1px;  background-color:White"> 
        ...
        <div class="bd">
            ...
            <br />
            <b>Path:</b><span id="<%=ClientID%>_lblPath" ></span>
            <br />
            <div align="center" >
