...
{
    public class ProyectoEvaluacionSectorialIndicadorData : _ProyectoEvaluacionSectorialIndicadorData 
    {
	   #region Singleton
	   private static volatile ProyectoEvaluacionSectorialIndicadorData current;
	   private static object syncRoot = new Object();

	   //private ProyectoEvaluacionSectorialIndicadorData() {}
	   public static ProyectoEvaluacionSectorialIndicadorData Current
	   {
		  get 
		  {
			 if (current == null) 
			 {
				...
				{
				   if (current == null) 
					   current = new ProyectoEvaluacionSectorialIndicadorData();
				}
			 }
			 return current;
		  }
       ...
       #endregion
       public override string IdFieldName { get { return "IdProyectoEvaluacionSectorialIndicador"; } }
