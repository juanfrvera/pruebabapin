...
namespace UI.Web
{
    public partial class ProyectoProductoIntermedioPageEdit : ProyectoPageEditTabPanel<nc.ProyectoProductoIntermedioCompose>
    {        
        #region Override        
        ...
        {
            webControlEdit = this.editProyectoProductoIntermedio;
        ...
        protected override IEntityService<nc.ProyectoProductoIntermedioCompose, nc.ProyectoFilter, nc.ProyectoResult, int> EntityService
        {
            get { return ProyectoProductoIntermedioComposeService.Current; }
        }
        protected override void _SetPermissions()
        {
            ...
            {
                enableUpdate = CanByOffice("ProyectoProductoIntermedioCompose", Entity.Proyecto.PerfilOficinas, ActionConfig.UPDATE, Entity.Proyecto.IdEstado);
