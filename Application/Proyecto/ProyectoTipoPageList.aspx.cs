...
namespace UI.Web
{    
	public partial class ProyectoTipoPageList : PageList<nc.ProyectoTipo ,nc.ProyectoTipoFilter, nc.ProyectoTipoResult, int>
    {
		...
		protected override IViewService<nc.ProyectoTipo ,nc.ProyectoTipoFilter,ProyectoTipoResult, int> ViewService
        {
            get { return Service; }
        }
