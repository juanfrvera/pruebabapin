<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FuenteFinanciamientoList.ascx.cs" Inherits=" UI.Web.FuenteFinanciamientoList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
    <asp:TemplateField   HeaderText="Padre"  SortExpression="FuenteFinanciamientoPadre_BreadcrumbCodeOrden" HeaderStyle-Width="25%" >            
            <ItemTemplate>
...
<asp:BoundField DataField="Codigo" HeaderText="Código" SortExpression="Codigo" HeaderStyle-Width="8%" />
	<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre" HeaderStyle-Width="25%" >            
            <ItemTemplate>
                <asp:Label ID="lblNombre" runat="server" Text='<%# Contract.DataHelper.CutString((string)Eval("Nombre"),50) %>' ToolTip='<%# Eval("Nombre") %>'  ></asp:Label>
            </ItemTemplate>
    </asp:TemplateField>
	<asp:BoundField DataField="FuenteFinanciamientoTipo_Nombre" HeaderText="Nivel/Tipo" SortExpression="FuenteFinanciamientoTipo_Nombre" HeaderStyle-Width="25%"/>
