<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PlanTipoList.ascx.cs" Inherits=" UI.Web.PlanTipoList" %>
...
<asp:BoundField DataField="Sigla" HeaderText="Sigla" SortExpression="Sigla" HeaderStyle-Width="8%"/>
	<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre"  HeaderStyle-Width="57%">            
            <ItemTemplate>
