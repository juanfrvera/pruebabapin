...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre" HeaderStyle-Width="38%" >            
            <ItemTemplate>
                <asp:Label ID="lblNombre" runat="server" Text='<%# Contract.DataHelper.CutString((string)Eval("Nombre"),45) %>' ToolTip='<%# Eval("Nombre") %>'  ></asp:Label>
            </ItemTemplate>
    </asp:TemplateField>
	<asp:BoundField DataField="SistemaEntidad_Nombre" HeaderText="Sistema Entidad" SortExpression="SistemaEntidad_Nombre" HeaderStyle-Width="25%"/>
	<asp:BoundField DataField="SistemaAccion_Nombre" HeaderText="Acción" SortExpression="SistemaAccion_Nombre" HeaderStyle-Width="20%"/>
