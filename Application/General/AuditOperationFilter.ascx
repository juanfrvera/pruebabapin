...
<tr>
	    ...
	    <td class="tdFilter" width="25%" >
	        <div ><asp:Literal ID="liSesion" Text="Sesión" runat="server" ></asp:Literal><asp:RegularExpressionValidator ID="revSessionId" runat="server"  ControlToValidate="txtSessionId" ValidationGroup="FilterAuditOperation" Text="*" Width="1px" Height="1px"></asp:RegularExpressionValidator></div>
        ...
        <td class="tdFilter" width="25%" >
            <div ><asp:Literal ID="liOperacion" Text="Operación" runat="server" ></asp:Literal>&nbsp;<asp:RegularExpressionValidator ID="revOperation" runat="server"  ControlToValidate="txtOperation" ValidationGroup="FilterAuditOperation" Text="*" Width="1px" Height="1px"></asp:RegularExpressionValidator></div>
