...
namespace Contract.Base
{
    ...
    public abstract class _CaracterEconomicoFilter : Filter
    {   
		#region Private
		...
		#endregion
		#region Properties
		[DataMember(Name = "IdCaracterEconomico", IsRequired = false)]public int? IdCaracterEconomico{get;set;}		
		 ...
		 [DataMember(Name = "IdCaracterEconomicoTipo", IsRequired = false)]public int? IdCaracterEconomicoTipo{get;set;}		
[DataMember(Name = "Activo", IsRequired = false)]public bool? Activo{get;set;}		
[DataMember(Name = "IdCaracterEconomicoPadreIsNull", IsRequired = false)]
			  public bool? IdCaracterEconomicoPadreIsNull{get;set;}[DataMember(Name = "IdCaracterEconomicoPadre", IsRequired = false)]public int? IdCaracterEconomicoPadre{get;set;}		
[DataMember(Name = "VisibleIsNull", IsRequired = false)]
			  public bool? VisibleIsNull{get;set;}[DataMember(Name = "Visible", IsRequired = false)]public bool? Visible{get;set;}		
...
public int? Orden_To{get;set;}		
		 ...
		 [DataMember(Name = "SeleccionableIsNull", IsRequired = false)]
			  public bool? SeleccionableIsNull{get;set;}[DataMember(Name = "Seleccionable", IsRequired = false)]public bool? Seleccionable{get;set;}		
