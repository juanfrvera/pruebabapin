...
namespace UI.Web
{    
	public partial class PrestamoEstadoPageListEdit : PageListEdit<nc.PrestamoEstado ,nc.PrestamoEstadoFilter, nc.PrestamoEstadoResult, int>
    {
		#region Override
		protected override void _Initialize()
        {
			base._Initialize();
            pnPopUpEditPrestamoEstado.Attributes.CssStyle.Add("display", "none");
        }	
        ...
        {            
            base.ShowEdit();
            IsActivePopup = true;
            upEditPrestamoEstado.Update();
            ModalPopupExtenderEditPrestamoEstado.Show();            
        }
        ...
        protected override void HideEdit()
        {
            ...
            IsActivePopup = false;
            ActivePopupName = "";
            ModalPopupExtenderEditPrestamoEstado.Hide();
        }
        #endregion
		#region Events
