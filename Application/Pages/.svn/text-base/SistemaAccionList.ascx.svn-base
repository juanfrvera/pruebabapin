<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SistemaAccionList.ascx.cs" Inherits=" UI.Web.SistemaAccionList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:TemplateField   HeaderText="Código"  SortExpression="Codigo"  HeaderStyle-Width="10%">            
            <ItemTemplate>
                <asp:Label ID="lblCodigo" runat="server" Text='<%# Contract.DataHelper.CutString((string)Eval("Codigo"),25) %>' ToolTip='<%# Eval("Codigo") %>'  ></asp:Label>
            </ItemTemplate>
    </asp:TemplateField>
	<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre"  HeaderStyle-Width="46%">            
            <ItemTemplate>
    ...
    <asp:CheckBoxField DataField="IncluirEstado" HeaderText="Incluye Estado" SortExpression="IncluirEstado" HeaderStyle-Width="20%" />
	<asp:CheckBoxField DataField="Activo" HeaderText="Activo" SortExpression="Activo" HeaderStyle-Width="15%"/>
