<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganismoTipoList.ascx.cs" Inherits=" UI.Web.OrganismoTipoList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="Nombre" HeaderText="Nombre" SortExpression="Nombre" HeaderStyle-Width="82%"/>
