<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebControl_Oficinas.ascx.cs" Inherits="UI.Web.WebControl_Oficinas" %>
...
<asp:Panel ID="pnControl" runat="server"  >
    ...
    <div id="<%=ClientID%>_panel"  style="visibility:hidden;  height:1px;  background-color:White"> 
        ...
        <div class="bd">
            <asp:DropDownList ID="ddlJurisdiccion" runat="server" SkinID="AnchoLibre" Width="100%" CssClass="field_input"  ></asp:DropDownList>
            <div style="height:270px; overflow:auto" id="<%=ClientID%>_tree"></div>
...
function <%=ClientID%>Open(){<%=ClientID%>SetTreeData();TreeData.Open();document.getElementById('<%=ddlJurisdiccion.ClientID%>').value = 0;}
