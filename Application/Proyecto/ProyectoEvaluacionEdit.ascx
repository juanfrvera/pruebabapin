...
<div class="CollapsiblePanelTab">
    <span id="spanBeneficios">
        <asp:Label ID="lblBeneficios" runat="server" Text="Otros Indicadores"></asp:Label>
        ...
        <asp:UpdatePanel ID="upIndicadoresBeneficioPopUp" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <table width="100%" cellpadding="0" cellspacing="5px" border="0">
                    ...
                    <tr>
                        <td width="220px">
                            <asp:Literal ID="Literal4" Text="Sector" runat="server"></asp:Literal>
                        </td>
                        <td>
                            <asp:Literal ID="Literal5" Text="Indicador" runat="server"></asp:Literal>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Literal ID="ltMonto" Text="Monto" runat="server"></asp:Literal>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="vertical-align:middle">
                            ...
                            <asp:RangeValidator
                                    ...
                                    Text="*"
                                    Type="Integer"
                                    ValidationGroup="vgIndicadorBeneficio"
                                    Width="1px"
                                    Height="1px"
                                />
                        </td>
