...
namespace UI.Web
{
    ...
    public class ClasificacionGeograficaAutocompleteHandler : IHttpHandler
    {

        public void ProcessRequest(HttpContext context)
        {
            nc.ClasificacionGeograficaFilter filter=null;
            string query = "";
            int aux;
            ...
            try
            {
                ...
                filter = JsonConvert.DeserializeObject<nc.ClasificacionGeograficaFilter>(jsonFilter);
            ...
            if(filter==null)filter = new nc.ClasificacionGeograficaFilter();
            ...
            nodes.Nodes = ClasificacionGeograficaService.Current.GetNodesResult(filter);
