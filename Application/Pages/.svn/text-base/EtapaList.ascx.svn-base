<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EtapaList.ascx.cs" Inherits=" UI.Web.EtapaList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="Fase_Nombre" HeaderText="Fase" SortExpression="Fase_Nombre" HeaderStyle-Width="33%"/>
