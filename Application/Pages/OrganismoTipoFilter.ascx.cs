...
namespace UI.Web
{
    public partial class OrganismoTipoFilter : WebControlFilter<nc.OrganismoTipoFilter>
    {
		protected override void _Initialize()
        {
            base._Initialize();
			revNombre.ValidationExpression=Contract.DataHelper.GetExpRegStringNullable(25);
