...
namespace UI.Web
{    
	public partial class ClasificacionGeograficaPageListEdit : PageListEdit<nc.ClasificacionGeografica ,nc.ClasificacionGeograficaFilter, nc.ClasificacionGeograficaResult, int>
    {
		#region Override
		protected override void _Initialize()
        {
			base._Initialize();
            pnPopUpEditClasificacionGeografica.Attributes.CssStyle.Add("display", "none");
        }	
        ...
        {            
            base.ShowEdit();
            IsActivePopup = true;
            upEditClasificacionGeografica.Update();
            ModalPopupExtenderEditClasificacionGeografica.Show();            
        }
        ...
        protected override void HideEdit()
        {
            ...
            IsActivePopup = false;
            ActivePopupName = "";
            ModalPopupExtenderEditClasificacionGeografica.Hide();
        }
        #endregion
		#region Events
