<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MonedaList.ascx.cs" Inherits=" UI.Web.MonedaList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
    <asp:BoundField DataField="Nombre" HeaderText="Nombre" SortExpression="Nombre" HeaderStyle-Width="63%"/>
<asp:BoundField DataField="Sigla" HeaderText="Sigla" SortExpression="Sigla" HeaderStyle-Width="8%"/>
	
	<asp:CheckBoxField DataField="Base" HeaderText="Moneda Base" SortExpression="Base" HeaderStyle-Width="10%"/>
	<asp:CheckBoxField DataField="Activo" HeaderText="Activo" SortExpression="Activo" HeaderStyle-Width="10%"/>
