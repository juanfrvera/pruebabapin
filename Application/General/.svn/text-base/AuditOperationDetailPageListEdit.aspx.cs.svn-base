...
namespace UI.Web
{    
	public partial class AuditOperationDetailPageListEdit : PageListEdit<nc.AuditOperationDetail ,nc.AuditOperationDetailFilter, nc.AuditOperationDetailResult, int>
    {
		#region Override
		protected override void _Initialize()
        {
			base._Initialize();
            pnPopUpEditAuditOperationDetail.Attributes.CssStyle.Add("display", "none");
        }	
        ...
        {            
            base.ShowEdit();
            IsActivePopup = true;
            upEditAuditOperationDetail.Update();
            ModalPopupExtenderEditAuditOperationDetail.Show();            
        }
        ...
        protected override void HideEdit()
        {
            ...
            IsActivePopup = false;
            ActivePopupName = "";
            ModalPopupExtenderEditAuditOperationDetail.Hide();
        }
        #endregion
		#region Events
