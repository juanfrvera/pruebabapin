<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestTreeView2.aspx.cs" Inherits="Application.Test.TestTreeView2" %>
<%@ Register Tagprefix="uc" TagName="TreeOficinas" Src="~/ControlsPersonal/WebControl_Oficinas.ascx"   %>
<%@ Register Tagprefix="uc" TagName="TreeFuentesFinanciamiento" Src="~/ControlsPersonal/WebControl_FuenteFinanciamiento.ascx"   %>
...
<body class="yui-skin-sam" >
    ...
    <div>
       ...
       <uc:TreeOficinas runat="server" ID="tsoficinas" ></uc:TreeOficinas>
    </div>
    </form>
</body>
</html>
