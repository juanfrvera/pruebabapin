<%@ Page Title="" Language="C#" MasterPageFile="~/App_Shared/General.Master" AutoEventWireup="true" CodeBehind="Matching_ProyectosND.aspx.cs" Inherits="UI.Web.Matching.Matching_ProyectosND" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    ...
    <fieldset>
     <legend><asp:Literal ID="Literal1" Text="Proyectos Vinculados ND" runat="server" ></asp:Literal></legend>
      ...
      <tr>
          <td><h2>Proyectos Matching ND</h2></td></tr>
        ...
        <tr>
            <td>
                ...
                -->
                <asp:GridView ID="grdProyectosND"  
                      autogeneratecolumns="false"
                    emptydatatext="Sin datos disponibles!"
                    AllowPaging="true" PageSize="10" runat="server" AllowSorting="true" OnPageIndexChanging="grdProyectosND_PageIndexChanging"  >
                    
               <Columns>
                  
                   <asp:BoundField DataField="ProyectoND" HeaderText="BapinesIncluidos" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right"  />
