...
{
    public abstract class _PrestamoObjetivoData : EntityData<PrestamoObjetivo,PrestamoObjetivoFilter,PrestamoObjetivoResult,int>
    { 		
		#region Context        
        ...
        #endregion		
		#region Get
		public override int GetId(nc.PrestamoObjetivo entity)
		{			
			return entity.IdPrestamoObjetivo;
		}		
		public override PrestamoObjetivo GetByEntity(PrestamoObjetivo entity)
        {
            return this.GetById(entity.IdPrestamoObjetivo);
        }
        public override PrestamoObjetivo GetById(int id)
        {
            return (from o in this.Table where o.IdPrestamoObjetivo == id select o).FirstOrDefault();
        }
		#endregion
		#region Query
		protected override IQueryable<PrestamoObjetivo> Query(PrestamoObjetivoFilter filter)
        {
			return (from o in this.Table
                      where (filter.IdPrestamoObjetivo == null || o.IdPrestamoObjetivo >=  filter.IdPrestamoObjetivo) && (filter.IdPrestamoObjetivo_To == null || o.IdPrestamoObjetivo <= filter.IdPrestamoObjetivo_To)
        ...
        protected override IQueryable<PrestamoObjetivoResult> QueryResult(PrestamoObjetivoFilter filter)
        {
		  return (from o in Query(filter)					
				   ...
				   select new PrestamoObjetivoResult(){
					 IdPrestamoObjetivo=o.IdPrestamoObjetivo
		...
		#endregion
		#region Copy
		public override nc.PrestamoObjetivo Copy(nc.PrestamoObjetivo entity)
        {           
            nc.PrestamoObjetivo _new = new nc.PrestamoObjetivo();
		 _new.IdPrestamo= entity.IdPrestamo;
		 _new.IdObjetivo= entity.IdObjetivo;
		return _new;			
        }
		public override int CopyAndSave(PrestamoObjetivo entity,string renameFormat)
        {
            PrestamoObjetivo  newEntity = Copy(entity);
            Add(newEntity);
			return GetId(newEntity);
        }
		#endregion
		#region Set
		public override void SetId(PrestamoObjetivo entity, int id)
        {            
            entity.IdPrestamoObjetivo = id;            
        }
		public override void Set(PrestamoObjetivo source,PrestamoObjetivo target,bool hadSetId)
		{		   
		if(hadSetId)target.IdPrestamoObjetivo= source.IdPrestamoObjetivo ;
		 target.IdPrestamo= source.IdPrestamo ;
		 target.IdObjetivo= source.IdObjetivo ;
		 		  
		}
		public override void Set(PrestamoObjetivoResult source,PrestamoObjetivo target,bool hadSetId)
		{		   
		if(hadSetId)target.IdPrestamoObjetivo= source.IdPrestamoObjetivo ;
		 target.IdPrestamo= source.IdPrestamo ;
		 target.IdObjetivo= source.IdObjetivo ;
		...
		public override void Set(PrestamoObjetivo source,PrestamoObjetivoResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdPrestamoObjetivo= source.IdPrestamoObjetivo ;
		 target.IdPrestamo= source.IdPrestamo ;
		 target.IdObjetivo= source.IdObjetivo ;
		...
		public override void Set(PrestamoObjetivoResult source,PrestamoObjetivoResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdPrestamoObjetivo= source.IdPrestamoObjetivo ;
		 target.IdPrestamo= source.IdPrestamo ;
		 target.IdObjetivo= source.IdObjetivo ;
		...
		#endregion			
		#region Equals
		public override bool Equals(PrestamoObjetivo source,PrestamoObjetivo target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
         if(!source.IdPrestamoObjetivo.Equals(target.IdPrestamoObjetivo))return false;
		  if(!source.IdPrestamo.Equals(target.IdPrestamo))return false;
		  if(!source.IdObjetivo.Equals(target.IdObjetivo))return false;
		 
		  return true;
        }
		public override bool Equals(PrestamoObjetivoResult source,PrestamoObjetivoResult target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
