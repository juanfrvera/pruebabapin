<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EstadoList.ascx.cs" Inherits=" UI.Web.EstadoList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="Codigo" HeaderText="Estado" SortExpression="Codigo" HeaderStyle-Width="8%"/>
	<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre" HeaderStyle-Width="34%" >            
            <ItemTemplate>
	...
	<asp:TemplateField   HeaderText="Descripción"  SortExpression="Descripcion" HeaderStyle-Width="33%" >            
            <ItemTemplate>
                <asp:Label ID="lblDescripcion" runat="server" Text='<%# Contract.DataHelper.CutString((string)Eval("Descripcion"),40) %>' ToolTip='<%# Eval("Descripcion") %>'  ></asp:Label>
            </ItemTemplate>
    </asp:TemplateField>
