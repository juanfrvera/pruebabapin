<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigurationCategoryList.ascx.cs" Inherits=" UI.Web.ConfigurationCategoryList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:TemplateField   HeaderText="Nombre"  SortExpression="Name" HeaderStyle-Width="91%" >            
            <ItemTemplate>
                <asp:Label ID="lblName" runat="server" Text='<%# Contract.DataHelper.CutString((string)Eval("Name"),100) %>' ToolTip='<%# Eval("Name") %>'  ></asp:Label>
            </ItemTemplate>
    </asp:TemplateField>
