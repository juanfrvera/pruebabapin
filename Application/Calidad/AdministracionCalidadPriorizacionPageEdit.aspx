<%@ Page Language="C#" MasterPageFile="~/App_Shared/General.Master" AutoEventWireup="true" CodeBehind="AdministracionCalidadPriorizacionPageEdit.aspx.cs" Inherits="UI.Web.AdministracionCalidadPriorizacionPageEdit" %>
<%@ Register Assembly="System.Web.Entity, Version=3.5.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" Namespace="System.Web.UI.WebControls" TagPrefix="asp" %>
<%@ Register Tagprefix="uc"  TagName="EditAdministracionCalidad" Src="~/Calidad/AdministracionCalidadPriorizacionEdit.ascx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
 <asp:UpdatePanel ID="upHeader" runat = "server" UpdateMode = "Conditional" >
       <ContentTemplate >
         <table width="100%">
            <tr>
                <td width="700px"><uc:ProyectoCalidadHead ID="proyectoCalidadHead" runat="server" /></td>
                <td  align="right" valign="bottom" width="500px" ><uc:PaggingInPage ID="paggingInPage" runat="server" /></td>
            </tr>
         </table> 
   </ContentTemplate>
 </asp:UpdatePanel>
