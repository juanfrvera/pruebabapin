...
{
    public class FileInfoData : EntityData<FileInfo, FileInfoFilter, FileInfoResult, int>
    {
	   #region Singleton
	   private static volatile FileInfoData current;
	   private static object syncRoot = new Object();

	   //private FileInfoData() {}
	   public static FileInfoData Current
	   {
		  get 
		  {
			 if (current == null) 
       ...
       #endregion
       public override string IdFieldName { get { return "IdFileInfo"; } }  
