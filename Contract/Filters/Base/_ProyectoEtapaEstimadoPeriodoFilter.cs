...
namespace Contract.Base
{
    ...
    public abstract class _ProyectoEtapaEstimadoPeriodoFilter : Filter
    {   
		#region Private
		
		#endregion
		#region Properties
		[DataMember(Name = "IdProyectoEtapaEstimadoPeriodo", IsRequired = false)]public int? IdProyectoEtapaEstimadoPeriodo{get;set;}		
        [DataMember(Name = "IdProyectoEtapaEstimadoPeriodo_To", IsRequired = false)]		
        public int? IdProyectoEtapaEstimadoPeriodo_To{get;set;}		
        [DataMember(Name = "IdProyectoEtapaEstimado", IsRequired = false)]public int? IdProyectoEtapaEstimado{get;set;}		
