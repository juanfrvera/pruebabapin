<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebControl_IndicadorClaseTreeSinSector.ascx.cs" Inherits="UI.Web.ControlsPersonal.WebControl_IndicadorClaseTreeSinSector" %>
