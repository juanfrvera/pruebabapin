<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProcesoList.ascx.cs" Inherits=" UI.Web.ProcesoList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="ProyectoTipo_Nombre" HeaderText="Clasif. Ecónomica" SortExpression="ProyectoTipo_Nombre" HeaderStyle-Width="23%"/>
	<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre"  HeaderStyle-Width="60%">            
            <ItemTemplate>
