...
{
    public partial class ProyectoObjetivosPageEdit : ProyectoPageEditTabPanel<nc.ProyectoObjetivosCompose>
    {
        #region Override        
        protected override void _Load()
        {
            webControlEdit = this.editProyectoObjetivos;
        ...
        protected override IEntityService<nc.ProyectoObjetivosCompose, nc.ProyectoFilter, nc.ProyectoResult, int> EntityService
        {
            get { return ProyectoObjetivosComposeService.Current; }
        }
        protected override void _SetPermissions()
        {
            ...
            {
                enableUpdate = CanByOffice("ProyectoObjetivosCompose", Entity.Proyecto.PerfilOficinas, ActionConfig.UPDATE, Entity.Proyecto.IdEstado);
