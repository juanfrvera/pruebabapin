<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ModalidadFinancieraList.ascx.cs" Inherits=" UI.Web.ModalidadFinancieraList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
	...
	<asp:BoundField DataField="OrganismoFinanciero_Nombre" HeaderText="Organismo Financiero" SortExpression="OrganismoFinanciero_Nombre" HeaderStyle-Width="20%"/>
	<asp:BoundField DataField="Sigla" HeaderText="Sigla" SortExpression="Sigla" HeaderStyle-Width="8%"/>
	<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre" HeaderStyle-Width="43%" >            
            <ItemTemplate>
