...
namespace UI.Web
{    
	public partial class ParameterPageListEdit : PageListEdit<nc.Parameter ,nc.ParameterFilter, nc.ParameterResult, int>
    {
		#region Override
		protected override void _Initialize()
        {
			base._Initialize();
            pnPopUpEditParameter.Attributes.CssStyle.Add("display", "none");
        }	
        ...
        {            
            base.ShowEdit();
            IsActivePopup = true;
            upEditParameter.Update();
            ModalPopupExtenderEditParameter.Show();            
        }
        ...
        protected override void HideEdit()
        {
            ...
            IsActivePopup = false;
            ActivePopupName = "";
            ModalPopupExtenderEditParameter.Hide();
        }
        #endregion
		#region Events
