...
namespace UI.Web
{
    ...
    public class FinalidadFuncionAutocompleteHandler : IHttpHandler
    {

        public void ProcessRequest(HttpContext context)
        {
            nc.FinalidadFuncionFilter filter = null;
            string query = "";
            int aux;
            ...
            try
            {
                ...
                filter = JsonConvert.DeserializeObject<nc.FinalidadFuncionFilter>(jsonFilter);
            ...
            if (filter == null) filter = new nc.FinalidadFuncionFilter();
            ...
            nodes.Nodes = FinalidadFuncionService.Current.GetNodesResult(filter);
