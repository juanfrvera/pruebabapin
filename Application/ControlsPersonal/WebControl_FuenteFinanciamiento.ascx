<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebControl_FuenteFinanciamiento.ascx.cs" Inherits="UI.Web.ControlsPersonal.WebControl_FuenteFinanciamiento" %>
