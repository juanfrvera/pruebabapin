...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <table width="100%"  >
        ...
        <tr>
            <td>
                <asp:ValidationSummary ID="vsFilterConfigurationCategory" runat="server" DisplayMode="BulletList"
                    ValidationGroup="FilterConfigurationCategory" ShowSummary="false"
