...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="IdCaracterEconomico" HeaderText="Caracter Económico" SortExpression="IdCaracterEconomico" />
	...
	<asp:BoundField DataField="CaracterEconomicoTipo_Nombre" HeaderText="Tipo de Caracter Económico" SortExpression="CaracterEconomicoTipo_Nombre" />
	<asp:CheckBoxField DataField="Activo" HeaderText="Activo" SortExpression="Activo" />
	<asp:BoundField DataField="CaracterEconomico_Nombre" HeaderText="Caracter Económico Padre" SortExpression="CaracterEconomico_Nombre" />
