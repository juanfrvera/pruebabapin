...
namespace Contract.Base
{
    ...
    public abstract class _FuenteFinanciamientoFilter : Filter
    {   
		#region Private
...
[DataMember(Name = "IdFuenteFinanciamientoPadreIsNull", IsRequired = false)]
			  public bool? IdFuenteFinanciamientoPadreIsNull{get;set;}[DataMember(Name = "IdFuenteFinanciamientoPadre", IsRequired = false)]public int? IdFuenteFinanciamientoPadre{get;set;}		
