...
namespace QiHe.Office.CompoundDocumentFormat
{
    public partial class CompoundDocument
    {
        ...
        internal CompoundDocument(Stream stream, FileHeader header)
            :this(stream,header, FileAccess.ReadWrite)
        {}
        internal CompoundDocument(Stream stream, FileHeader header, FileAccess fileAccess)
        {
        ...
        {
            return Open(stream, FileAccess.ReadWrite);
        }
        public static CompoundDocument Open(Stream stream, FileAccess fileAccess)
        {

            BinaryReader reader = new BinaryReader(stream);
            FileHeader header = ReadHeader(reader);

            CompoundDocument document = new CompoundDocument(stream, header,fileAccess);
