<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AnioList.ascx.cs" Inherits=" UI.Web.AnioList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="IdAnio" HeaderText="Anio" SortExpression="IdAnio" HeaderStyle-Width="8%"/>
	<asp:BoundField DataField="Nombre" HeaderText="Nombre" SortExpression="Nombre" HeaderStyle-Width="75%"/>
