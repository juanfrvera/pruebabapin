...
{
    public partial class PrestamoDictamenSeguimientoPageEdit : PageEditTabPanel<nc.PrestamoDictamenCompose, nc.PrestamoDictamenFilter, nc.PrestamoDictamenResult, int>
    {
        #region Override
        ...
        {
            webControlEdit = this.editPrestamoSeguimientoEstado;
