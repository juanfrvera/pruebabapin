...
{
    public class ProyectoRelacionData : EntityData<ProyectoRelacion, ProyectoRelacionFilter, ProyectoRelacionResult, int>
    { 
	   #region Singleton
	   private static volatile ProyectoRelacionData current;
	   private static object syncRoot = new Object();

	   //private ProyectoRelacionData() {}
	   public static ProyectoRelacionData Current
	   {
		  get 
		  {
			 if (current == null) 
			 {
				...
				{
				   if (current == null) 
					   current = new ProyectoRelacionData();
				}
			 }
			 return current;
		  }
       ...
       #endregion
       public override string IdFieldName { get { return "IdProyectoRelacion"; } }
