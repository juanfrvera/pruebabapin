...
namespace UI.Web
{
    ...
    public class CaracterEconomicoAutocompleteHandler : IHttpHandler
    {

        public void ProcessRequest(HttpContext context)
        {
            nc.CaracterEconomicoFilter filter = null;
            string query = "";
            int aux;
            ...
            try
            {
                ...
                filter = JsonConvert.DeserializeObject<nc.CaracterEconomicoFilter>(jsonFilter);
            ...
            if (filter == null) filter = new nc.CaracterEconomicoFilter();
            ...
            nodes.Nodes = CaracterEconomicoService.Current.GetNodesResult(filter);
