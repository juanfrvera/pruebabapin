<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProyectoGeoreferenciacionList.ascx.cs" Inherits=" UI.Web.ProyectoGeoreferenciacionList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="Proyecto_ProyectoDenominacion" HeaderText="Proyecto" SortExpression="Proyecto_ProyectoDenominacion" />
