...
namespace UI.Web
{
    public partial class ProyectoCronogramaPageEdit : ProyectoPageEditTabPanel<nc.ProyectoCronogramaCompose>
    {        
        #region Override       
        ...
        {
            webControlEdit = this.editProyectoCronograma;
        ...
        protected override IEntityService<nc.ProyectoCronogramaCompose, nc.ProyectoFilter, nc.ProyectoResult, int> EntityService
        {
            get { return ProyectoCronogramaComposeService.Current; }
        }
        protected override void _SetPermissions()
        {
            ...
            {
                enableUpdate = CanByOffice("ProyectoCronogramaCompose", Entity.Proyecto.PerfilOficinas, ActionConfig.UPDATE, Entity.Proyecto.IdEstado);
