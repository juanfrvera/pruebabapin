<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebControl_ClasificacionGasto.ascx.cs" Inherits="UI.Web.ControlsPersonal.WebControl_ClasificacionGasto" %>
