...
namespace UI.Web
{
    public partial class ProyectoEvaluacionPageEdit : ProyectoPageEditTabPanel<nc.ProyectoEvaluacionCompose>
    {
        #region Override        
        ...
        {
            webControlEdit = this.editProyectoEvaluacion;
        ...
        protected override IEntityService<nc.ProyectoEvaluacionCompose, nc.ProyectoFilter, nc.ProyectoResult, int> EntityService
        {
            get { return ProyectoEvaluacionComposeService.Current; }
        }
        protected override void _SetPermissions()
        {
            ...
            {
                enableUpdate = CanByOffice("ProyectoEvaluacionCompose", Entity.Proyecto.PerfilOficinas, ActionConfig.UPDATE, Entity.Proyecto.IdEstado);
