...
namespace UI.Web
{    
	public partial class PerfilActividadPageListEdit : PageListEdit<nc.PerfilActividad ,nc.PerfilActividadFilter, nc.PerfilActividadResult, int>
    {
		#region Override
		protected override void _Initialize()
        {
			base._Initialize();
            pnPopUpEditPerfilActividad.Attributes.CssStyle.Add("display", "none");
        }	
        ...
        {            
            base.ShowEdit();
            IsActivePopup = true;
            upEditPerfilActividad.Update();
            ModalPopupExtenderEditPerfilActividad.Show();            
        }
        ...
        protected override void HideEdit()
        {
            ...
            IsActivePopup = false;
            ActivePopupName = "";
            ModalPopupExtenderEditPerfilActividad.Hide();
        }
        #endregion
		#region Events
