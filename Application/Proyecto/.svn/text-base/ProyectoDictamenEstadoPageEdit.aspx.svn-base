<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProyectoDictamenEstadoPageEdit.aspx.cs" Inherits="UI.Web.ProyectoDictamenEstadoPageEdit" MasterPageFile="~/App_Shared/General.Master" %>

<%@ Register Assembly="System.Web.Entity, Version=3.5.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" Namespace="System.Web.UI.WebControls" TagPrefix="asp" %>
<%@ Register Tagprefix="uc"  TagName="ProyectoDictamenEstadoEdit" Src="ProyectoDictamenEstadoEdit.ascx" %>
        ...
        <tr>
            <td>
               <asp:Panel ID="pnEdicionArchivo" runat="server">
                   <uc:ProyectoDictamenEstadoEdit  runat="server" ID="editProyectoEstado" ></uc:ProyectoDictamenEstadoEdit>
                </asp:Panel>
            </td>
        </tr>
		<tr>
