...
{
    public abstract class _ProyectoIndicadorObjetivosGobiernoData : EntityData<ProyectoIndicadorObjetivosGobierno,ProyectoIndicadorObjetivosGobiernoFilter,ProyectoIndicadorObjetivosGobiernoResult,int>
    { 		
		#region Context        
        ...
        #endregion		
		#region Get
		public override int GetId(nc.ProyectoIndicadorObjetivosGobierno entity)
		{			
			return entity.IdProyectoIndicadorObjetivosGobierno;
		}		
		public override ProyectoIndicadorObjetivosGobierno GetByEntity(ProyectoIndicadorObjetivosGobierno entity)
        {
            return this.GetById(entity.IdProyectoIndicadorObjetivosGobierno);
        }
        public override ProyectoIndicadorObjetivosGobierno GetById(int id)
        {
            return (from o in this.Table where o.IdProyectoIndicadorObjetivosGobierno == id select o).FirstOrDefault();
        }
		#endregion
		#region Query
		protected override IQueryable<ProyectoIndicadorObjetivosGobierno> Query(ProyectoIndicadorObjetivosGobiernoFilter filter)
        {
			return (from o in this.Table
                      where (filter.IdProyectoIndicadorObjetivosGobierno == null || o.IdProyectoIndicadorObjetivosGobierno >=  filter.IdProyectoIndicadorObjetivosGobierno) && (filter.IdProyectoIndicadorObjetivosGobierno_To == null || o.IdProyectoIndicadorObjetivosGobierno <= filter.IdProyectoIndicadorObjetivosGobierno_To)
		...
		#endregion
		#region Copy
		public override nc.ProyectoIndicadorObjetivosGobierno Copy(nc.ProyectoIndicadorObjetivosGobierno entity)
        {           
            nc.ProyectoIndicadorObjetivosGobierno _new = new nc.ProyectoIndicadorObjetivosGobierno();
		...
		public override int CopyAndSave(ProyectoIndicadorObjetivosGobierno entity,string renameFormat)
        {
            ProyectoIndicadorObjetivosGobierno  newEntity = Copy(entity);
		...
		#endregion
		#region Set
		public override void SetId(ProyectoIndicadorObjetivosGobierno entity, int id)
        {            
            entity.IdProyectoIndicadorObjetivosGobierno = id;            
        }
		public override void Set(ProyectoIndicadorObjetivosGobierno source,ProyectoIndicadorObjetivosGobierno target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoIndicadorObjetivosGobierno= source.IdProyectoIndicadorObjetivosGobierno ;
		...
		public override void Set(ProyectoIndicadorObjetivosGobiernoResult source,ProyectoIndicadorObjetivosGobierno target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoIndicadorObjetivosGobierno= source.IdProyectoIndicadorObjetivosGobierno ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdIndicadorClase= source.IdIndicadorClase ;
		...
		public override void Set(ProyectoIndicadorObjetivosGobierno source,ProyectoIndicadorObjetivosGobiernoResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoIndicadorObjetivosGobierno= source.IdProyectoIndicadorObjetivosGobierno ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdIndicadorClase= source.IdIndicadorClase ;
		...
		public override void Set(ProyectoIndicadorObjetivosGobiernoResult source,ProyectoIndicadorObjetivosGobiernoResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoIndicadorObjetivosGobierno= source.IdProyectoIndicadorObjetivosGobierno ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdIndicadorClase= source.IdIndicadorClase ;
		...
		#endregion			
		#region Equals
		public override bool Equals(ProyectoIndicadorObjetivosGobierno source,ProyectoIndicadorObjetivosGobierno target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
         if(!source.IdProyectoIndicadorObjetivosGobierno.Equals(target.IdProyectoIndicadorObjetivosGobierno))return false;
		...
		public override bool Equals(ProyectoIndicadorObjetivosGobiernoResult source,ProyectoIndicadorObjetivosGobiernoResult target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
