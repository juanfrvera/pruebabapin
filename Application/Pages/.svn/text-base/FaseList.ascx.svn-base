<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FaseList.ascx.cs" Inherits=" UI.Web.FaseList" %>
...
<asp:BoundField DataField="Codigo" HeaderText="Código" SortExpression="Codigo" HeaderStyle-Width="8%"/>
	<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre" HeaderStyle-Width="67%" >            
            <ItemTemplate>
