...
namespace Contract.Base
{
    ...
    {   
        ...
        [DataMember(Name = "AnioCorrienteEstimadoIsNull", IsRequired = false)]
        public bool? AnioCorrienteEstimadoIsNull { get; set; }
        [DataMember(Name = "AnioCorrienteEstimado", IsRequired = false)]
        public int? AnioCorrienteEstimado { get; set; }
        [DataMember(Name = "AnioCorrienteEstimado_To", IsRequired = false)]
        public int? AnioCorrienteEstimado_To { get; set; }
        [DataMember(Name = "AnioCorrienteRealizadoIsNull", IsRequired = false)]
        public bool? AnioCorrienteRealizadoIsNull { get; set; }
        [DataMember(Name = "AnioCorrienteRealizado", IsRequired = false)]
        public int? AnioCorrienteRealizado { get; set; }
        [DataMember(Name = "AnioCorrienteRealizado_To", IsRequired = false)]
        public int? AnioCorrienteRealizado_To { get; set; }		
