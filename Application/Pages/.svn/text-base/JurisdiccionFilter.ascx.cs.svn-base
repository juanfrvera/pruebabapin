...
namespace UI.Web
{
    public partial class JurisdiccionFilter : WebControlFilter<nc.JurisdiccionFilter>
    {
		protected override void _Initialize()
        {
            base._Initialize();
			revCodigo.ValidationExpression=Contract.DataHelper.GetExpRegStringNullable(15);
			revNombre.ValidationExpression=Contract.DataHelper.GetExpRegStringNullable(120);
