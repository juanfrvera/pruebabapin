...
{
    public class ProyectoFileData : EntityData<ProyectoFile, ProyectoFileFilter, ProyectoFileResult, int>
    {
        #region Singleton
        private static volatile ProyectoFileData current;
        private static object syncRoot = new Object();

        //private ProyectoFileData() {}
        public static ProyectoFileData Current
        {
            get
            {
                if (current == null)
        ...
        #endregion
        public override string IdFieldName { get { return "IdProyectoFile"; } }
