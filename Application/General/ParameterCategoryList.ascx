<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParameterCategoryList.ascx.cs" Inherits=" UI.Web.ParameterCategoryList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:TemplateField   HeaderText="Nombre"  SortExpression="Name"  HeaderStyle-Width="31%">            
            <ItemTemplate>
                <asp:Label ID="lblName" runat="server" Text='<%# Contract.DataHelper.CutString((string)Eval("Name"),25) %>' ToolTip='<%# Eval("Name") %>'  ></asp:Label>
            </ItemTemplate>
    </asp:TemplateField>
	<asp:TemplateField   HeaderText="Descripción"  SortExpression="Description"  HeaderStyle-Width="60%">            
            <ItemTemplate>
