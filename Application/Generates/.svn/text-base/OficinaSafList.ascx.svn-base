<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OficinaSafList.ascx.cs" Inherits=" UI.Web.OficinaSafList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="Oficina_Nombre" HeaderText="Oficina" SortExpression="Oficina_Nombre" />
	<asp:BoundField DataField="Saf_Codigo" HeaderText="Saf" SortExpression="Saf_Codigo" />
