...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    <Columns> 
            ...
            <asp:BoundField DataField="ProyectoCalificacion_Nombre" HeaderText="Calificación" SortExpression="ProyectoCalificacion_Nombre" />
            <asp:BoundField DataField="Fecha" HeaderText="Fecha Calificación" SortExpression="Fecha" DataFormatString="{0:dd/MM/yyyy}"  />
            <asp:BoundField DataField="UltimoEstadoNombre" HeaderText="Estado" SortExpression="UltimoEstadoNombre" />
            <asp:TemplateField HeaderText="Informe Técnico"  SortExpression="InformeTecnico"  >            
                <ItemTemplate>
