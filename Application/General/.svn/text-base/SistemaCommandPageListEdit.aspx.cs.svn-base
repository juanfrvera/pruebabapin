...
namespace UI.Web
{    
	public partial class SistemaCommandPageListEdit : PageListEdit<nc.SistemaCommand ,nc.SistemaCommandFilter, nc.SistemaCommandResult, int>
    {
		#region Override
		protected override void _Initialize()
        {
			base._Initialize();
            pnPopUpEditSistemaCommand.Attributes.CssStyle.Add("display", "none");
        }	
        ...
        {            
            base.ShowEdit();
            IsActivePopup = true;
            upEditSistemaCommand.Update();
            ModalPopupExtenderEditSistemaCommand.Show();            
        }
        ...
        protected override void HideEdit()
        {
            ...
            IsActivePopup = false;
            ActivePopupName = "";
            ModalPopupExtenderEditSistemaCommand.Hide();
        }
        #endregion
		#region Events
