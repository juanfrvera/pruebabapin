<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganismoPrioridadList.ascx.cs" Inherits=" UI.Web.OrganismoPrioridadList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="Nombre" HeaderText="Nombre" SortExpression="Nombre" HeaderStyle-Width="83%"/>
