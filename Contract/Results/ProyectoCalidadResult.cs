...
{
    [Serializable]
    public class ProyectoCalidadResult : IResult<int>
    {
        #region Clase Base
        ...
        public bool EstadoSugeridoOK
        {
            get { return this.EstadoOK > 0; }
            set { this.EstadoOK = (value) ? 1 : 0; }

        }
        public virtual int ID { get { return IdProyecto; } }
        public string EstadoSugerido { get; set; }
        public bool Proyecto_Activo { get; set; }
        public string Proyecto_EstadoNombre { get; set; }
        public string Proyecto_ProcesoNombre { get; set; }
        public string Proyecto_FinalidadDenominacion { get; set; }
        public string Proyecto_PlanNombre { get; set; }
        public string Proyecto_CodigoCompuesto { get; set; }
        public string Proyecto_Analista { get; set; }

        public List<ProyectoCalidadProvinciaResult> ProvinciasActual = new List<ProyectoCalidadProvinciaResult>();
        public List<ProyectoCalidadProvinciaResult> ProvinciasSugeridas = new List<ProyectoCalidadProvinciaResult>();
        public string ProvinciasActualStr
        {
            get
            {
                string rv = "";
                foreach (ProyectoCalidadProvinciaResult p in ProvinciasActual)
                    rv += (rv != "") ? " / " + p.NombreProvincia : p.NombreProvincia;
                return rv;
            }
        }
        public string ProvinciasSugeridasStr
        {
            get
            {
                string rv = "";
                foreach (ProyectoCalidadProvinciaResult p in ProvinciasSugeridas)
                    rv += (rv != "") ? " / " + p.NombreProvincia : p.NombreProvincia;
                return rv;
            }
        }
        ...
        public  DataTableMapping ToMapping()
        {
            return new DataTableMapping("ProyectoCalidad", new List<DataColumnMapping>(new DataColumnMapping[]{
             new DataColumnMapping("Analista","Proyecto_Analista")			
            ,new DataColumnMapping("SAF.PG.SP","Proyecto_CodigoCompuesto")			
            ,new DataColumnMapping("NroProyecto","Proyecto_Codigo")			
            ,new DataColumnMapping("DenominacionActual","Proyecto_ProyectoDenominacion")			
            ...
            ,new DataColumnMapping("DenominacionOK","DenominacionOK")
   			,new DataColumnMapping("EstadoActual","Proyecto_EstadoNombre")
			,new DataColumnMapping("EstadoSugerido","EstadoSugerido")
			,new DataColumnMapping("EstadoOK","EstadoSugeridoOK")
			,new DataColumnMapping("ProcesoActual","Proyecto_ProcesoNombre")
            ,new DataColumnMapping("ProcesoSugerido","Proceso_Nombre")
			,new DataColumnMapping("ProcesoOk","ProcesoOk")
			,new DataColumnMapping("FinalidadActual","Proyecto_FinalidadDenominacion")
  			,new DataColumnMapping("FinalidadSugerida","ClasificacionFuncional_Denominacion")
			,new DataColumnMapping("FinalidadFuncionOk","FinalidadFuncionOk")
            ,new DataColumnMapping("ProvinciasActual","ProvinciasActualStr")
            ,new DataColumnMapping("PrvinciasSugeridas","ProvinciasSugeridasStr")
            ,new DataColumnMapping("LocalizacionOK","LocalizacionOK")
            ,new DataColumnMapping("ReqDictamen","ReqDictamen")
            ,new DataColumnMapping("UltimoPlan","Proyecto_PlanNombre")
			,new DataColumnMapping("Estado","Estado_Descripcion")
    ...
    [Serializable]
    public class ProyectoCalidadProvinciaResult
    {
