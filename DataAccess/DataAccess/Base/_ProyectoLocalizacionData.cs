...
{
    public abstract class _ProyectoLocalizacionData : EntityData<ProyectoLocalizacion,ProyectoLocalizacionFilter,ProyectoLocalizacionResult,int>
    { 		
		#region Context        
        ...
        #endregion		
		#region Get
		public override int GetId(nc.ProyectoLocalizacion entity)
		{			
			return entity.IdProyectoLocalizacion;
		}		
		public override ProyectoLocalizacion GetByEntity(ProyectoLocalizacion entity)
        {
            return this.GetById(entity.IdProyectoLocalizacion);
        }
        public override ProyectoLocalizacion GetById(int id)
        {
            return (from o in this.Table where o.IdProyectoLocalizacion == id select o).FirstOrDefault();
        }
		#endregion
		#region Query
		protected override IQueryable<ProyectoLocalizacion> Query(ProyectoLocalizacionFilter filter)
        {
			return (from o in this.Table
                      where (filter.IdProyectoLocalizacion == null || o.IdProyectoLocalizacion >=  filter.IdProyectoLocalizacion) && (filter.IdProyectoLocalizacion_To == null || o.IdProyectoLocalizacion <= filter.IdProyectoLocalizacion_To)
        ...
        protected override IQueryable<ProyectoLocalizacionResult> QueryResult(ProyectoLocalizacionFilter filter)
        {
		  return (from o in Query(filter)					
				   ...
				   select new ProyectoLocalizacionResult(){
					 IdProyectoLocalizacion=o.IdProyectoLocalizacion
		...
		#endregion
		#region Copy
		public override nc.ProyectoLocalizacion Copy(nc.ProyectoLocalizacion entity)
        {           
            nc.ProyectoLocalizacion _new = new nc.ProyectoLocalizacion();
		 _new.IdProyecto= entity.IdProyecto;
		 _new.IdClasificacionGeografica= entity.IdClasificacionGeografica;
		return _new;			
        }
		public override int CopyAndSave(ProyectoLocalizacion entity,string renameFormat)
        {
            ProyectoLocalizacion  newEntity = Copy(entity);
            Add(newEntity);
			return GetId(newEntity);
        }
		#endregion
		#region Set
		public override void SetId(ProyectoLocalizacion entity, int id)
        {            
            entity.IdProyectoLocalizacion = id;            
        }
		public override void Set(ProyectoLocalizacion source,ProyectoLocalizacion target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoLocalizacion= source.IdProyectoLocalizacion ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdClasificacionGeografica= source.IdClasificacionGeografica ;
		 		  
		}
		public override void Set(ProyectoLocalizacionResult source,ProyectoLocalizacion target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoLocalizacion= source.IdProyectoLocalizacion ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdClasificacionGeografica= source.IdClasificacionGeografica ;
		...
		public override void Set(ProyectoLocalizacion source,ProyectoLocalizacionResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoLocalizacion= source.IdProyectoLocalizacion ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdClasificacionGeografica= source.IdClasificacionGeografica ;
		...
		public override void Set(ProyectoLocalizacionResult source,ProyectoLocalizacionResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoLocalizacion= source.IdProyectoLocalizacion ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdClasificacionGeografica= source.IdClasificacionGeografica ;
		...
		#endregion			
		#region Equals
		public override bool Equals(ProyectoLocalizacion source,ProyectoLocalizacion target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
         if(!source.IdProyectoLocalizacion.Equals(target.IdProyectoLocalizacion))return false;
		...
		public override bool Equals(ProyectoLocalizacionResult source,ProyectoLocalizacionResult target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
