<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PrestamoDictamenSeguimientoEdit.ascx.cs" Inherits="UI.Web.Prestamo.PrestamoDictamenSeguimientoEdit" %>
...
<asp:Panel ID="pnlPrestamoDictamenSeguimientoEstado" runat ="server"  GroupingText ="Seguimiento de Estados" >
    <asp:UpdatePanel ID="upGridPrestamoDictamenSeguimientoEstado" runat = "server" >
        <ContentTemplate >
            <table width="100%">
                <tr>
                    <td>
                        <asp:GridView 
                            ID="gridPrestamoDictamenSeguimientoEstado" 
                            runat ="server" 
                            AutoGenerateColumns="False" 
                            DataKeyNames="ID" 
                            AllowPaging="True" 
                            OnRowCommand="GridPrestamoDictamenSeguimientoEstado_RowCommand"    
                            AllowSorting="False"
                            OnSorting="GridPrestamoDictamenSeguimientoEstado_Sorting"
                            OnPageIndexChanging="GridPrestamoDictamenSeguimientoEstado_PageIndexChanging" 
                            ...
                            <Columns >
                                ...
                                <asp:TemplateField HeaderStyle-Width ="7%">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        &nbsp;
                                        <asp:ImageButton ID ="imgDelete" runat ="server"  src="../Images/delete.jpg" ToolTip ="Eliminar" CommandName='<%# Command.DELETE %>'   OnClientClick='<%#  "return confirm(\""+ConfirmDeleteMessage+"\")" %>' CommandArgument='<%#Eval("ID")%>' Enabled='<%# EnablePrestamoDictamenEstadoDelete %>'    CausesValidation="false" />            
                                    </ItemTemplate>            
        ...
        <asp:UpdatePanel ID="upEstadosPopUp" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <table width="100%">
                    <tr>
                        <td align="center">                                
                            <asp:Button ID="btCancelEstados" Text="Cerrar" OnClick="btCancelPrestamoDictamenSeguimientoEstado_Click"
