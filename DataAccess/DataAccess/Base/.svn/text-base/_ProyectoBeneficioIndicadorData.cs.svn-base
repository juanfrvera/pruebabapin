...
{
    public abstract class _ProyectoBeneficioIndicadorData : EntityData<ProyectoBeneficioIndicador,ProyectoBeneficioIndicadorFilter,ProyectoBeneficioIndicadorResult,int>
    { 		
		#region Context        
        ...
        #endregion		
		#region Get
		public override int GetId(nc.ProyectoBeneficioIndicador entity)
		{			
			return entity.IdProyectoBeneficioIndicador;
		}		
		public override ProyectoBeneficioIndicador GetByEntity(ProyectoBeneficioIndicador entity)
        {
            return this.GetById(entity.IdProyectoBeneficioIndicador);
        }
        public override ProyectoBeneficioIndicador GetById(int id)
        {
            return (from o in this.Table where o.IdProyectoBeneficioIndicador == id select o).FirstOrDefault();
        }
		#endregion
		#region Query
		protected override IQueryable<ProyectoBeneficioIndicador> Query(ProyectoBeneficioIndicadorFilter filter)
        {
			return (from o in this.Table
                      where (filter.IdProyectoBeneficioIndicador == null || o.IdProyectoBeneficioIndicador >=  filter.IdProyectoBeneficioIndicador) && (filter.IdProyectoBeneficioIndicador_To == null || o.IdProyectoBeneficioIndicador <= filter.IdProyectoBeneficioIndicador_To)
		...
		#endregion
		#region Copy
		public override nc.ProyectoBeneficioIndicador Copy(nc.ProyectoBeneficioIndicador entity)
        {           
            nc.ProyectoBeneficioIndicador _new = new nc.ProyectoBeneficioIndicador();
		...
		public override int CopyAndSave(ProyectoBeneficioIndicador entity,string renameFormat)
        {
            ProyectoBeneficioIndicador  newEntity = Copy(entity);
            Add(newEntity);
			return GetId(newEntity);
        }
		#endregion
		#region Set
		public override void SetId(ProyectoBeneficioIndicador entity, int id)
        {            
            entity.IdProyectoBeneficioIndicador = id;            
        }
		public override void Set(ProyectoBeneficioIndicador source,ProyectoBeneficioIndicador target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoBeneficioIndicador= source.IdProyectoBeneficioIndicador ;
		...
		public override void Set(ProyectoBeneficioIndicadorResult source,ProyectoBeneficioIndicador target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoBeneficioIndicador= source.IdProyectoBeneficioIndicador ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdIndicadorClase= source.IdIndicadorClase ;
		...
		public override void Set(ProyectoBeneficioIndicador source,ProyectoBeneficioIndicadorResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoBeneficioIndicador= source.IdProyectoBeneficioIndicador ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdIndicadorClase= source.IdIndicadorClase ;
		...
		public override void Set(ProyectoBeneficioIndicadorResult source,ProyectoBeneficioIndicadorResult target,bool hadSetId)
		{		   
		if(hadSetId)target.IdProyectoBeneficioIndicador= source.IdProyectoBeneficioIndicador ;
		 target.IdProyecto= source.IdProyecto ;
		 target.IdIndicadorClase= source.IdIndicadorClase ;
		...
		#endregion			
		#region Equals
		public override bool Equals(ProyectoBeneficioIndicador source,ProyectoBeneficioIndicador target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
         if(!source.IdProyectoBeneficioIndicador.Equals(target.IdProyectoBeneficioIndicador))return false;
		...
		public override bool Equals(ProyectoBeneficioIndicadorResult source,ProyectoBeneficioIndicadorResult target)
        {
		   if(source == null && target == null)return true;
		   if(source == null )return false;
		   if(target == null)return false;
