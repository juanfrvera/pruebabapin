...
namespace Contract.Base
{
    ...
    public abstract class _ProyectoIndicadorObjetivosGobiernoFilter : Filter
    {   
		#region Private
		...
		#endregion
		#region Properties
		[DataMember(Name = "IdProyectoIndicadorObjetivosGobierno", IsRequired = false)]public int? IdProyectoIndicadorObjetivosGobierno{get;set;}		
[DataMember(Name = "IdProyectoIndicadorObjetivosGobierno_To", IsRequired = false)]		
public int? IdProyectoIndicadorObjetivosGobierno_To{get;set;}		
