<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PerfilList.ascx.cs" Inherits=" UI.Web.PerfilList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre" HeaderStyle-Width="50%" >            
            <ItemTemplate>
                <asp:Label ID="lblNombre" runat="server" Text='<%# Contract.DataHelper.CutString((string)Eval("Nombre"),60) %>' ToolTip='<%# Eval("Nombre") %>'  ></asp:Label>
            </ItemTemplate>
    </asp:TemplateField>
	<asp:BoundField DataField="PerfilTipo_Nombre" HeaderText="Tipo de Perfil" SortExpression="PerfilTipo_Nombre" HeaderStyle-Width="23%"/>
	<asp:CheckBoxField DataField="Activo" HeaderText="Activo" SortExpression="Activo" HeaderStyle-Width="9%"/>
	<asp:CheckBoxField DataField="EsDefault" HeaderText="Es Default" SortExpression="EsDefault" HeaderStyle-Width="9%"/>
