<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebControl_LocalizacionGeografica.ascx.cs" Inherits="UI.Web.WebControl_LocalizacionGeografica" %>
...
<asp:Panel ID="pnControl" runat="server"  >
    <table width="100%"  cellpadding="0px" cellspacing="0px">
        ...
        <td width="55px" >
            <img src="../Images/OrganizationalUnit.png" style="cursor:pointer<%= Enabled==true?"":";visibility:hidden" %>"    onclick="<%=ClientID%>Open()" /> 
            <img src="../App_Themes/Sky/Images/Icons/clearb.gif" style="cursor:pointer<%= Enabled==true?"":";visibility:hidden" %>"   onclick="<%=ClientID%>Clear()" />
       </td>
       </tr>
    </table>     
