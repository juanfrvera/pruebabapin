<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PerfilTipoList.ascx.cs" Inherits=" UI.Web.PerfilTipoList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
<asp:BoundField DataField="IdPerfilTipo" HeaderText="PerfilTipo" SortExpression="IdPerfilTipo" HeaderStyle-Width="8%"/>
