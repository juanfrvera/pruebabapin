<%@ Page Language="C#" MasterPageFile="~/App_Shared/General.Master" AutoEventWireup="true" CodeBehind="MessagePageList.aspx.cs" Inherits="UI.Web.MessagePageList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    <table width="100%"  >
        ...
        <tr>
            <td>
                <asp:ValidationSummary ID="vsFilterMessage" runat="server" DisplayMode="BulletList"
                    ValidationGroup="FilterMessage" ShowSummary="false"
