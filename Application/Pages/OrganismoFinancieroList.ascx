<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganismoFinancieroList.ascx.cs" Inherits=" UI.Web.OrganismoFinancieroList" %>
...
<asp:GridView ID="Grid" runat="server"  Width="100%"
    ...
    >
    <Columns> 
    <asp:TemplateField   HeaderText="Nombre"  SortExpression="Nombre" HeaderStyle-Width="75%" >            
            <ItemTemplate>
