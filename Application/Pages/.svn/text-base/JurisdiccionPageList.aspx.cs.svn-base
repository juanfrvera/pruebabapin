...
namespace UI.Web
{    
	public partial class JurisdiccionPageList : PageList<nc.Jurisdiccion ,nc.JurisdiccionFilter, nc.JurisdiccionResult, int>
    {
		...
		protected override IViewService<nc.Jurisdiccion ,nc.JurisdiccionFilter,JurisdiccionResult, int> ViewService
        {
            get { return Service; }
        }
